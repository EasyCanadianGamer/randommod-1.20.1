...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    RANDOMITE("randomite_ingot", 200, new int[]{ 9, 24, 18, 9 }, 25,
            SoundEvents.ARMOR_EQUIP_NETHERITE, 20f, 0.5f, () -> Ingredient.of(ModItems.RANDOMITE_INGOT.get()));
    ...
    private static final int[] BASE_DURABILITY = {  33, 48, 45,39 };
